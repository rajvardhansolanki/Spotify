...
const playlist = [
  ...
  {
    title: "Dhadak 2",
    artist: "Jubin Nautiyal|Darshan Raval|Arijit Singh",
  ...
  return (
    <div className="w-full h-full flex">
      ...
      <div className="md:w-2/6 w-full h-full p-2 flex gap-2 justify-between">
        <div className="w-[5rem] h-[4rem] overflow-hidden">
          <img
        ...
        <div className="md:w-full  px-1 text-white">
          <p className="text-[0.8rem] font-bold truncate">
            {currentSong.title}
          </p>
          <p className="text-[0.8rem]">{currentSong.artist}</p>
          <p className="text-[0.8rem] hidden md:block">
            {currentSong.artist}
          </p>
        </div>
        {/* Mobile play button */}
      ...
      <div className="w-full h-full hidden md:block p-3">
        <div className="w-full h-[50%] flex justify-center gap-8 items-center">
          {/* Previous */}
          <div onClick={handlePrev} className="cursor-pointer">
            <svg
              ...
              strokeWidth="1.5"
              stroke="currentColor"
              className="w-6 h-6 stroke-amber-50 scale-x-[-1]"
            >
              <path
                strokeLinecap="round"
          ...
          <div onClick={togglePlay} className="cursor-pointer">
            {isPlaying ? (
              <svg
                ...
                strokeWidth="1.5"
                stroke="currentColor"
                className="w-8 h-8 stroke-amber-50"
              >
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  d="M6.75 4.5h2.25v15H6.75V4.5zm8.25 0h2.25v15H15V4.5z"
                />
              </svg>
            ) : (
              <svg
          ...
          <div onClick={handleNext} className="cursor-pointer">
            <svg
              ...
              strokeWidth="1.5"
              stroke="currentColor"
              className="w-6 h-6 stroke-amber-50"
            >
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
