...
const Home = () => {
  return (
    <>
      ...
      <div className="w-full bg-gradient-to-b from-[#4d0c0c] to-black text-white p-6">
        <div className="flex items-center gap-6 mb-6">
          <button className="bg-green-500 p-4 rounded-full shadow-lg hover:scale-105 transition">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 stroke-1 stroke-black">
